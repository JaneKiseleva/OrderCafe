...
public class CreateOrderActivity extends AppCompatActivity {
    ...
    private Spinner spinnerOfTea;
    private Spinner spinnerOfCoffee;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerOfTea = findViewById(R.id.optionsOfTea);
    ...
    public void onClickChangeDrink(View view) {
        ...
        if (id == R.id.radioButtonTea) {
            drink = getString(R.string.tea);
            spinnerOfTea.setVisibility(View.VISIBLE);
            spinnerOfCoffee.setVisibility(View.INVISIBLE);
            checkBoxLemon.setVisibility(View.VISIBLE);
        } else if (id == R.id.radioButtonCoffee) {
            drink = getString(R.string.coffee);
            spinnerOfTea.setVisibility(View.INVISIBLE);
            spinnerOfCoffee.setVisibility(View.VISIBLE);
